...
<!--[if gt IE 8]><!--><html class="no-js" lang="sv"><!--<![endif]-->
    ...
    <body class="dark">
        <form id="default" runat="server" onsubmit="return false;" enableviewstate="false">
            <header>
                <h1>FiberKartan - Projekteringsverktyg för socken- och byanät</h1>
                <p>
            ...
            <div class="images">
                <a class="image" rel="group1" href="/inc/img/firstpage/ViewAdminMap.jpg" target="_blank" title="Ritläge"><img src="/inc/img/firstpage/tn_ViewAdminMap.jpg" alt="Ritläge" /></a>
            </div>
            <footer>
                <div class="copyright">&copy;Liquidbytes.se Henrik Östman</div>
            </footer>
        </form>
