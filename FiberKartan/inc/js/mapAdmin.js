...
$(document).ready(function () {
    ...
    var accord_state = JSON.parse($.cookie('palette_accordion')) || { show: true, markers: true, search: true, printing: true };
    if (!accord_state.show) $("#togglePanels .showPanel").hide();
    if (!accord_state.markers) $("#togglePanels #markerTypes").hide();
    if (!accord_state.search) $("#togglePanels .searchPanel").hide();
    if (!accord_state.printing) $("#togglePanels .viewSettingsBox").hide();
    ...
    var mapOptions = {
        zoom: 9.0,
        center: new google.maps.LatLng(57.47614, 18.45059), // Mitt på Gotland.
